...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
			.authorizeRequests()
			.antMatchers("/authenticate", "/tkb/users","/tkb/save", "/tkb/all","/tkb/{id}","/{postId}/likes","/comment",
					"/comment/{postId}","/tkb/group/create",
					"/tkb/group/{groupId}","/tkb/getAllGroups","/tkb/{groupId}/join",
					"/tkb/{groupId}/users","/tkb/{groupId}/total-users").permitAll()
